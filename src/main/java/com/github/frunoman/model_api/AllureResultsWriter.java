...
public interface AllureResultsWriter {
     ...
     *                                     during operation.
     */
    void write(TestResult testResult) throws IOException;
     ...
     *                                     during operation.
     */
    void write(TestResultContainer testResultContainer) throws IOException;
     ...
     */
    void write(String source, InputStream attachment) throws IOException;
